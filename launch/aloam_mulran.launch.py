...
def generate_launch_description():
    ...
    params = {'scan_line': 64, 'mapping_skip_frame': 1, 'minimum_range': 0.5, 'mapping_line_resolution': 0.4, 'mapping_plane_resolution': 0.8, 'keyframe_meter_gap': 1.0, 'sc_dist_thres': 0.2, 'sc_max_radius': 80.0, 'lidar_type': 'OS1-64', 'save_directory': save_directory}

    nodes = [
        Node(package='aloam_velodyne', executable='ascanRegistration', name='ascanRegistration', output='screen', parameters=[params], remappings=[('/velodyne_points', '/os1_points')]),
