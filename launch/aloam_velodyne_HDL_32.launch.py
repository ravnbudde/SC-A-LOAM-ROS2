...
def generate_launch_description():
    ...
    params = {'scan_line': 32, 'mapping_skip_frame': 1, 'minimum_range': 0.3, 'mapping_line_resolution': 0.2, 'mapping_plane_resolution': 0.4, 'keyframe_meter_gap': 1.0, 'sc_dist_thres': 0.2, 'sc_max_radius': 80.0, 'lidar_type': 'HDL32', 'save_directory': save_directory}
